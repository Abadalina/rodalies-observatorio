...
Entra como `root` con la clave SSH que diste al crear la maquina y ejecuta el
script de aprovisionamiento:

```bash
git clone <url-del-repo> /tmp/repo
sudo bash /tmp/repo/scripts/bootstrap-vps.sh alex
```
